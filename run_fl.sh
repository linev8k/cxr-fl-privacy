...
python train_FL.py densenet_config.json -d /mnt/dsets/ -df ~/netstore/data_files/combined_files/ -o ~/netstore/densenet_combined

python train_FL.py resnet_config.json -d /mnt/dsets/ -df ~/netstore/data_files/combined_files/ -o ~/netstore/resnet_combined
